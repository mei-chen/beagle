...
class S3Test(TestCase):
    ...
    @mock.patch('integrations.tests.S3ConnectionMock.get_bucket',
    ...
    @mock.patch('integrations.tests.S3KeyMock.delete')
    ...
    @mock.patch('integrations.tests.S3KeyMock.set_contents_from_string')
    ...
    @mock.patch('integrations.tests.S3KeyMock.get_contents_as_string')
    ...
    @mock.patch('integrations.tests.S3KeyMock.set_contents_from_filename')
    ...
    @mock.patch('integrations.tests.S3KeyMock.get_contents_to_filename')
    ...
    @mock.patch('integrations.tests.S3KeyMock.set_contents_from_file')
    ...
    @mock.patch('integrations.tests.S3KeyMock.get_contents_to_file')
    ...
    @mock.patch('integrations.tests.S3KeyMock.set_metadata')
    ...
    @mock.patch('integrations.tests.S3KeyMock.get_metadata')
    ...
    def test_ssl_s3url(self):
        self.assertEqual(
            'https://s3.amazonaws.com/bucket.with.dots/filename',
            ssl_s3url('bucket.with.dots', 'filename')
        )
        self.assertEqual(
            'https://bucket-without-dots.s3.amazonaws.com/filename',
            ssl_s3url('bucket-without-dots', 'filename')
        )
