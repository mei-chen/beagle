...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DropboxAccess'
        db.create_table(u'watcher_dropboxaccess', (
        ...
        db.send_create_signal(u'watcher', ['DropboxAccess'])

        # Adding model 'GoogleDriveAccess'
        db.create_table(u'watcher_googledriveaccess', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('credentials', self.gf('jsonfield.fields.JSONField')()),
        ))
        db.send_create_signal(u'watcher', ['GoogleDriveAccess'])


    def backwards(self, orm):
        # Deleting model 'DropboxAccess'
        db.delete_table(u'watcher_dropboxaccess')

        # Deleting model 'GoogleDriveAccess'
        db.delete_table(u'watcher_googledriveaccess')
