...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Queue', fields ['cloud_id']
        db.delete_unique(u'watcher_queue', ['cloud_id'])

        # Removing unique constraint on 'Synchronized', fields ['cloud_id']
        db.delete_unique(u'watcher_synchronized', ['cloud_id'])

        # Adding index on 'Synchronized', fields ['cloud_id']
        db.create_index(u'watcher_synchronized', ['cloud_id'])

        # Adding index on 'Queue', fields ['cloud_id']
        db.create_index(u'watcher_queue', ['cloud_id'])


    def backwards(self, orm):
        # Removing index on 'Queue', fields ['cloud_id']
        db.delete_index(u'watcher_queue', ['cloud_id'])

        # Removing index on 'Synchronized', fields ['cloud_id']
        db.delete_index(u'watcher_synchronized', ['cloud_id'])

        # Adding unique constraint on 'Synchronized', fields ['cloud_id']
        db.create_unique(u'watcher_synchronized', ['cloud_id'])

        # Adding unique constraint on 'Queue', fields ['cloud_id']
        db.create_unique(u'watcher_queue', ['cloud_id'])
    ...
    models = {
        ...
        u'watcher.folder': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'folder_id': ('django.db.models.fields.CharField', [], {'max_length': '100', 'db_index': 'True'}),
        ...
        u'watcher.queue': {
            ...
            'cloud_id': ('django.db.models.fields.CharField', [], {'max_length': '200', 'db_index': 'True'}),
