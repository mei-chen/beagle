...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Folder.cloud' to match new field type.
        db.rename_column(u'watcher_folder', 'cloud_id', 'cloud')
        # Changing field 'Folder.cloud'
        db.alter_column(u'watcher_folder', 'cloud', self.gf('django.db.models.fields.CharField')(max_length='64'))
        # Removing index on 'Folder', fields ['cloud']
        db.delete_index(u'watcher_folder', ['cloud_id'])


    def backwards(self, orm):
        # Adding index on 'Folder', fields ['cloud']
        db.create_index(u'watcher_folder', ['cloud_id'])

        # Adding model 'Cloud'
        db.create_table(u'watcher_cloud', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=16, unique=True)),
        ))
        db.send_create_signal(u'watcher', ['Cloud'])


        # Renaming column for 'Folder.cloud' to match new field type.
        db.rename_column(u'watcher_folder', 'cloud', 'cloud_id')
        # Changing field 'Folder.cloud'
        db.alter_column(u'watcher_folder', 'cloud_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['watcher.Cloud']))
