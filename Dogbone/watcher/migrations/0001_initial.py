...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Cloud'
        db.create_table(u'watcher_cloud', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=16)),
        ))
        db.send_create_signal(u'watcher', ['Cloud'])

        # Adding model 'Folder'
        db.create_table(u'watcher_folder', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('folder_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
            ('folder_path', self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=120)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('cloud', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['watcher.Cloud'])),
        ))
        db.send_create_signal(u'watcher', ['Folder'])

        # Adding model 'CloudAppAccess'
        db.create_table(u'watcher_cloudappaccess', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('client_secret', self.gf('django.db.models.fields.files.FileField')(max_length=100, blank=True)),
            ('uploaded_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'watcher', ['CloudAppAccess'])

        # Adding model 'Access'
        db.create_table(u'watcher_access', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('token', self.gf('django.db.models.fields.CharField')(max_length=150, blank=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
        ))
        db.send_create_signal(u'watcher', ['Access'])

        # Adding model 'Synchronized'
        db.create_table(u'watcher_synchronized', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cloud_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=200)),
            ('folder', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['watcher.Folder'])),
            ('original_name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('name_without_type', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('document', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.Document'], unique=True, null=True)),
        ))
        db.send_create_signal(u'watcher', ['Synchronized'])

        # Adding model 'Queue'
        db.create_table(u'watcher_queue', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cloud_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=200)),
            ('cloud_path', self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True)),
            ('folder', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['watcher.Folder'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'watcher', ['Queue'])


    def backwards(self, orm):
        # Deleting model 'Cloud'
        db.delete_table(u'watcher_cloud')

        # Deleting model 'Folder'
        db.delete_table(u'watcher_folder')

        # Deleting model 'CloudAppAccess'
        db.delete_table(u'watcher_cloudappaccess')

        # Deleting model 'Access'
        db.delete_table(u'watcher_access')

        # Deleting model 'Synchronized'
        db.delete_table(u'watcher_synchronized')

        # Deleting model 'Queue'
        db.delete_table(u'watcher_queue')
    ...
    models = {
        ...
        u'core.document': {
            ...
            'upload_info': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['core.UploadInfo']", 'null': 'True'}),
        ...
        u'watcher.folder': {
            ...
            'cloud': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['watcher.Cloud']"}),
