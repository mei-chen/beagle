...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Folder', fields ['folder_id']
        db.delete_unique(u'watcher_folder', ['folder_id'])

        # Adding index on 'Folder', fields ['folder_id']
        db.create_index(u'watcher_folder', ['folder_id'])


    def backwards(self, orm):
        # Removing index on 'Folder', fields ['folder_id']
        db.delete_index(u'watcher_folder', ['folder_id'])

        # Adding unique constraint on 'Folder', fields ['folder_id']
        db.create_unique(u'watcher_folder', ['folder_id'])
