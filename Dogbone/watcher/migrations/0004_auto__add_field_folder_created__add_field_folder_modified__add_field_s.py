...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'watcher_folder', 'created',
                      self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Folder.modified'
        db.add_column(u'watcher_folder', 'modified',
                      self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Synchronized.created'
        db.add_column(u'watcher_synchronized', 'created',
                      self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Synchronized.modified'
        db.add_column(u'watcher_synchronized', 'modified',
                      self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Queue.created'
        db.add_column(u'watcher_queue', 'created',
                      self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Queue.modified'
        db.add_column(u'watcher_queue', 'modified',
                      self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Access.created'
        db.add_column(u'watcher_access', 'created',
                      self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Access.modified'
        db.add_column(u'watcher_access', 'modified',
                      self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'watcher_folder', 'created')

        # Deleting field 'Folder.modified'
        db.delete_column(u'watcher_folder', 'modified')

        # Deleting field 'Synchronized.created'
        db.delete_column(u'watcher_synchronized', 'created')

        # Deleting field 'Synchronized.modified'
        db.delete_column(u'watcher_synchronized', 'modified')

        # Deleting field 'Queue.created'
        db.delete_column(u'watcher_queue', 'created')

        # Deleting field 'Queue.modified'
        db.delete_column(u'watcher_queue', 'modified')

        # Deleting field 'Access.created'
        db.delete_column(u'watcher_access', 'created')

        # Deleting field 'Access.modified'
        db.delete_column(u'watcher_access', 'modified')
