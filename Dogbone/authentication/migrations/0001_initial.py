...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'authentication_authtoken', (
            ...
            ('key_expire', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'authentication', ['AuthToken'])


    def backwards(self, orm):
        # Deleting model 'AuthToken'
        db.delete_table(u'authentication_authtoken')
    ...
    models = {
        ...
        u'authentication.authtoken': {
            ...
            'key_expire': ('django.db.models.fields.DateTimeField', [], {}),
