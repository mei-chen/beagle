...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LearnerAttribute.name'
        db.add_column(u'ml_learnerattribute', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=300, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LearnerAttribute.name'
        db.delete_column(u'ml_learnerattribute', 'name')
