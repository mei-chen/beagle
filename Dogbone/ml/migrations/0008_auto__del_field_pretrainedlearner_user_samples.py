...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PretrainedLearner.user_samples'
        db.delete_column(u'ml_pretrainedlearner', 'user_samples')


    def backwards(self, orm):
        # Adding field 'PretrainedLearner.user_samples'
        db.add_column(u'ml_pretrainedlearner', 'user_samples',
