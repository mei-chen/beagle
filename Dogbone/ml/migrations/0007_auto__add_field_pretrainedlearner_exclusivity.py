...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PretrainedLearner.exclusivity'
        db.add_column(u'ml_pretrainedlearner', 'exclusivity',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PretrainedLearner.exclusivity'
        db.delete_column(u'ml_pretrainedlearner', 'exclusivity')
