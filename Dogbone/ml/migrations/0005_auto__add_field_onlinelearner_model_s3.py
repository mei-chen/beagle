...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OnlineLearner.model_s3'
        db.add_column(u'ml_onlinelearner', 'model_s3',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OnlineLearner.model_s3'
        db.delete_column(u'ml_onlinelearner', 'model_s3')
