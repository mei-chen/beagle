...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LearnerAttribute.pretrainedlearner_ptr'
        db.delete_column(u'ml_learnerattribute', u'pretrainedlearner_ptr_id')

        # Adding field 'LearnerAttribute.id'
        db.add_column(u'ml_learnerattribute', u'id',
                      self.gf('django.db.models.fields.AutoField')(default=None, primary_key=True),
                      keep_default=False)

        # Adding field 'LearnerAttribute.created'
        db.add_column(u'ml_learnerattribute', 'created',
                      self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'LearnerAttribute.modified'
        db.add_column(u'ml_learnerattribute', 'modified',
                      self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'LearnerAttribute.model_uuid'
        db.add_column(u'ml_learnerattribute', 'model_uuid',
                      self.gf('django.db.models.fields.CharField')(default=None, unique=True, max_length=100),
                      keep_default=False)

        # Adding field 'LearnerAttribute.tag'
        db.add_column(u'ml_learnerattribute', 'tag',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=300),
                      keep_default=False)

        # Adding field 'LearnerAttribute.description'
        db.add_column(u'ml_learnerattribute', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'LearnerAttribute.pretrainedlearner_ptr'
        db.add_column(u'ml_learnerattribute', u'pretrainedlearner_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=None, to=orm['ml.PretrainedLearner'], unique=True, primary_key=True),
                      keep_default=False)

        # Deleting field 'LearnerAttribute.id'
        db.delete_column(u'ml_learnerattribute', u'id')

        # Deleting field 'LearnerAttribute.created'
        db.delete_column(u'ml_learnerattribute', 'created')

        # Deleting field 'LearnerAttribute.modified'
        db.delete_column(u'ml_learnerattribute', 'modified')

        # Deleting field 'LearnerAttribute.model_uuid'
        db.delete_column(u'ml_learnerattribute', 'model_uuid')

        # Deleting field 'LearnerAttribute.tag'
        db.delete_column(u'ml_learnerattribute', 'tag')

        # Deleting field 'LearnerAttribute.description'
        db.delete_column(u'ml_learnerattribute', 'description')
