...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LearnerAttribute.parent_learner'
        db.add_column(u'ml_learnerattribute', 'parent_learner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='learner_attribute', null=True, to=orm['ml.PretrainedLearner']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LearnerAttribute.parent_learner'
        db.delete_column(u'ml_learnerattribute', 'parent_learner_id')
