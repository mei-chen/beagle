...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OnlineLearner.pretrained'
        db.add_column(u'ml_onlinelearner', 'pretrained',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OnlineLearner.pretrained'
        db.delete_column(u'ml_onlinelearner', 'pretrained')
