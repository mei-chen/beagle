...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OnlineLearner.active'
        db.add_column(u'ml_onlinelearner', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'OnlineLearner.deleted'
        db.add_column(u'ml_onlinelearner', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OnlineLearner.active'
        db.delete_column(u'ml_onlinelearner', 'active')

        # Deleting field 'OnlineLearner.deleted'
        db.delete_column(u'ml_onlinelearner', 'deleted')
