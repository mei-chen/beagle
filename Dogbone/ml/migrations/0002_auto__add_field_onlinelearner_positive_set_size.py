...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OnlineLearner.positive_set_size'
        db.add_column(u'ml_onlinelearner', 'positive_set_size',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OnlineLearner.positive_set_size'
        db.delete_column(u'ml_onlinelearner', 'positive_set_size')
