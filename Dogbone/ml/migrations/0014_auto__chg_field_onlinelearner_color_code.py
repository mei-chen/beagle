...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OnlineLearner.color_code'
        db.alter_column(u'ml_onlinelearner', 'color_code', self.gf('django.db.models.fields.CharField')(max_length=7))

    def backwards(self, orm):

        # Changing field 'OnlineLearner.color_code'
        db.alter_column(u'ml_onlinelearner', 'color_code', self.gf('django.db.models.fields.PositiveIntegerField')())
    ...
    models = {
        ...
        u'ml.onlinelearner': {
            ...
            'color_code': ('django.db.models.fields.CharField', [], {'default': "'#f9f6fb'", 'max_length': '7'}),
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
