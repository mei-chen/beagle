...
//Utils
import DropboxApi from 'utils/dropboxFolderPicker';

require('./styles/DropboxFolderPicker.scss');
  ...
  render() {
    ...
    return (
      <div className={dropboxFolder} onClick={this.handleFolderSelect} onDoubleClick={this.handleOpenFolder}>
        <div>
          <i className="fa fa-folder dropbox-folder-image" aria-hidden="true"/>
        </div>
      ...
      <Modal show={this.props.folderPickerState} onHide={this.props.closeFolderPicker} className="watcher-dialog">
        <Modal.Header>
          ...
          <div className="close" onClick={this.props.closeFolderPicker}>
            <i className="fa fa-times close-modal-folder" aria-hidden="true" />
          </div>
        </Modal.Header>
        <Modal.Body>
          ...
          <ButtonToolbar>
            {
              ...
              ? <Button className="activeButton" onClick={this.submit}>Select</Button>
