// @glifchits: I'm wrapping all this in a IIFE to make sure `Node` doesn't get
// defined globally. It conflicts with the browser implementation which is used
// by React internals to determine whether a given object is a DOM node.
//
(function(){
