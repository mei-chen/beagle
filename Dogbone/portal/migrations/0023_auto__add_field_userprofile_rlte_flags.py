...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.rlte_flags'
        db.add_column(u'portal_userprofile', 'rlte_flags',
                      self.gf('jsonfield.fields.JSONField')(default={'terminations': True, 'liabilities': True, 'responsibilities': True, 'external_references': True}),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.rlte_flags'
        db.delete_column(u'portal_userprofile', 'rlte_flags')
    ...
    models = {
        ...
        u'portal.userprofile': {
            ...
            'rlte_flags': ('jsonfield.fields.JSONField', [], {'default': "{'terminations': True, 'liabilities': True, 'responsibilities': True, 'external_references': True}"}),
