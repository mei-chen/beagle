...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.keywords_cache'
        db.add_column(u'portal_userprofile', 'keywords_cache',
                      self.gf('jsonfield.fields.JSONField')(default=None, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.keywords_cache'
        db.delete_column(u'portal_userprofile', 'keywords_cache')
    ...
    models = {
        ...
        u'portal.userprofile': {
            ...
            'keywords_cache': ('jsonfield.fields.JSONField', [], {'default': 'None', 'null': 'True'}),
