...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PasswordResetRequest.email_sent_date'
        db.add_column(u'portal_passwordresetrequest', 'email_sent_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PasswordResetRequest.email_sent_date'
        db.delete_column(u'portal_passwordresetrequest', 'email_sent_date')
