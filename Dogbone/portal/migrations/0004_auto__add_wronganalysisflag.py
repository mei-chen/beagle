...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WrongAnalysisFlag'
        db.create_table(u'portal_wronganalysisflag', (
            ...
            ('resolution_comments', self.gf('django.db.models.fields.TextField')(default='')),
        ))
        db.send_create_signal(u'portal', ['WrongAnalysisFlag'])


    def backwards(self, orm):
        # Deleting model 'WrongAnalysisFlag'
        db.delete_table(u'portal_wronganalysisflag')
    ...
    models = {
        ...
        u'portal.wronganalysisflag': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'resolution_comments': ('django.db.models.fields.TextField', [], {'default': "''"}),
