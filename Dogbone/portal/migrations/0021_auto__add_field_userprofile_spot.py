...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.spot'
        db.add_column(u'portal_userprofile', 'spot',
                      self.gf('jsonfield.fields.JSONField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.spot'
        db.delete_column(u'portal_userprofile', 'spot')
    ...
    models = {
        ...
        u'portal.userprofile': {
            ...
            'spot': ('jsonfield.fields.JSONField', [], {'default': 'None', 'null': 'True', 'blank': 'None'}),
