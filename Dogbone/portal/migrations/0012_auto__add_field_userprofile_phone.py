...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'portal_userprofile', 'phone',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=15),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.phone'
        db.delete_column(u'portal_userprofile', 'phone')
    ...
    models = {
        ...
        u'portal.userprofile': {
            ...
            'phone': ('django.db.models.fields.TextField', [], {'default': "''", 'max_length': '15'}),
