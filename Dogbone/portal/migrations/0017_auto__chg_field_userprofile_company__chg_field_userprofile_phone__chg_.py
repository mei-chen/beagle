...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'portal_userprofile', 'company', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'UserProfile.phone'
        db.alter_column(u'portal_userprofile', 'phone', self.gf('django.db.models.fields.TextField')(max_length=25, null=True))

        # Changing field 'UserProfile.job_title'
        db.alter_column(u'portal_userprofile', 'job_title', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.company'
        db.alter_column(u'portal_userprofile', 'company', self.gf('django.db.models.fields.TextField')())

        # Changing field 'UserProfile.phone'
        db.alter_column(u'portal_userprofile', 'phone', self.gf('django.db.models.fields.TextField')(max_length=25))

        # Changing field 'UserProfile.job_title'
        db.alter_column(u'portal_userprofile', 'job_title', self.gf('django.db.models.fields.TextField')())
