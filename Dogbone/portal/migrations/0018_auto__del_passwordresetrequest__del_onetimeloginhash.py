...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'portal_passwordresetrequest')

        # Deleting model 'OneTimeLoginHash'
        db.delete_table(u'portal_onetimeloginhash')


    def backwards(self, orm):
        # Adding model 'PasswordResetRequest'
        db.create_table(u'portal_passwordresetrequest', (
        ...
        db.send_create_signal(u'portal', ['PasswordResetRequest'])

        # Adding model 'OneTimeLoginHash'
        db.create_table(u'portal_onetimeloginhash', (
            ('resolved', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('start', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('secret', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True)),
        ...
        db.send_create_signal(u'portal', ['OneTimeLoginHash'])
