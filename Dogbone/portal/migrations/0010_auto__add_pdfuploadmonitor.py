...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PDFUploadMonitor'
        db.create_table(u'portal_pdfuploadmonitor', (
            ...
            ('docs_ocred', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('pages_ocred', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('startdate', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'portal', ['PDFUploadMonitor'])


    def backwards(self, orm):
        # Deleting model 'PDFUploadMonitor'
        db.delete_table(u'portal_pdfuploadmonitor')
