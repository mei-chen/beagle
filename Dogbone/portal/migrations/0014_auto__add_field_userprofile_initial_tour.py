...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.initial_tour'
        db.add_column(u'portal_userprofile', 'initial_tour',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.initial_tour'
        db.delete_column(u'portal_userprofile', 'initial_tour')
