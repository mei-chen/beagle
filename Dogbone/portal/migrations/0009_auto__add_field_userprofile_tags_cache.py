...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.tags_cache'
        db.add_column(u'portal_userprofile', 'tags_cache',
                      self.gf('jsonfield.fields.JSONField')(default=None, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.tags_cache'
        db.delete_column(u'portal_userprofile', 'tags_cache')
