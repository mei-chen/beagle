...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PasswordResetRequest.created'
        db.add_column(u'portal_passwordresetrequest', 'created',
                      self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'PasswordResetRequest.modified'
        db.add_column(u'portal_passwordresetrequest', 'modified',
                      self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PasswordResetRequest.created'
        db.delete_column(u'portal_passwordresetrequest', 'created')

        # Deleting field 'PasswordResetRequest.modified'
        db.delete_column(u'portal_passwordresetrequest', 'modified')
