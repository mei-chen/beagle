...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PDFUploadMonitor.startdate'
        db.alter_column(u'portal_pdfuploadmonitor', 'startdate', self.gf('django.db.models.fields.DateField')())
        # Adding field 'UserProfile.document_upload_count'
        db.add_column(u'portal_userprofile', 'document_upload_count',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'PDFUploadMonitor.startdate'
        db.alter_column(u'portal_pdfuploadmonitor', 'startdate', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
        # Deleting field 'UserProfile.document_upload_count'
        db.delete_column(u'portal_userprofile', 'document_upload_count')
    ...
    models = {
        ...
        u'portal.userprofile': {
            ...
            'document_upload_count': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
