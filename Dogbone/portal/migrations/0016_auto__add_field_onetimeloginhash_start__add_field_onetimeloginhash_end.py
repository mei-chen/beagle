...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OneTimeLoginHash.start'
        db.add_column(u'portal_onetimeloginhash', 'start',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'OneTimeLoginHash.end'
        db.add_column(u'portal_onetimeloginhash', 'end',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OneTimeLoginHash.start'
        db.delete_column(u'portal_onetimeloginhash', 'start')

        # Deleting field 'OneTimeLoginHash.end'
        db.delete_column(u'portal_onetimeloginhash', 'end')
