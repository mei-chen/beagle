...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurchasedSubscription.expire_info_emailed'
        db.add_column(u'marketing_purchasedsubscription', 'expire_info_emailed',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PurchasedSubscription.expire_warning_emailed'
        db.add_column(u'marketing_purchasedsubscription', 'expire_warning_emailed',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PurchasedSubscription.expire_info_emailed'
        db.delete_column(u'marketing_purchasedsubscription', 'expire_info_emailed')

        # Deleting field 'PurchasedSubscription.expire_warning_emailed'
        db.delete_column(u'marketing_purchasedsubscription', 'expire_warning_emailed')
    ...
    models = {
        ...
        u'marketing.purchasedsubscription': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'end': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'expire_info_emailed': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'expire_warning_emailed': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'start': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'subscription': ('django.db.models.fields.CharField', [], {'max_length': '200'})
