...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PaymentRecord.ip_address'
        db.add_column(u'marketing_paymentrecord', 'ip_address',
                      self.gf('django.db.models.fields.IPAddressField')(max_length=15, null=True),
                      keep_default=False)

        # Adding field 'PaymentRecord.browser'
        db.add_column(u'marketing_paymentrecord', 'browser',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)

        # Adding field 'PaymentRecord.processing_time'
        db.add_column(u'marketing_paymentrecord', 'processing_time',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PaymentRecord.ip_address'
        db.delete_column(u'marketing_paymentrecord', 'ip_address')

        # Deleting field 'PaymentRecord.browser'
        db.delete_column(u'marketing_paymentrecord', 'browser')

        # Deleting field 'PaymentRecord.processing_time'
        db.delete_column(u'marketing_paymentrecord', 'processing_time')
