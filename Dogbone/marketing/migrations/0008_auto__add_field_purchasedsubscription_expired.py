...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurchasedSubscription.expired'
        db.add_column(u'marketing_purchasedsubscription', 'expired',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PurchasedSubscription.expired'
        db.delete_column(u'marketing_purchasedsubscription', 'expired')
