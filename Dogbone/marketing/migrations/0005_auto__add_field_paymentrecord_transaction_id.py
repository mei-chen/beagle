...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PaymentRecord.transaction_id'
        db.add_column(u'marketing_paymentrecord', 'transaction_id',
                      self.gf('django.db.models.fields.TextField')(max_length=200, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PaymentRecord.transaction_id'
        db.delete_column(u'marketing_paymentrecord', 'transaction_id')
