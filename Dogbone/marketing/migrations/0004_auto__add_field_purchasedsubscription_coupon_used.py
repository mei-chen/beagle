...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurchasedSubscription.coupon_used'
        db.add_column(u'marketing_purchasedsubscription', 'coupon_used',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['marketing.Coupon'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PurchasedSubscription.coupon_used'
        db.delete_column(u'marketing_purchasedsubscription', 'coupon_used_id')
    ...
    models = {
        ...
        u'marketing.purchasedsubscription': {
            ...
            'buyer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'coupon_used': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['marketing.Coupon']", 'null': 'True'}),
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'end': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
