...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.processing_begin_ts'
        db.add_column(u'core_document', 'processing_begin_ts',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True),
                      keep_default=False)

        # Adding field 'Document.processing_end_ts'
        db.add_column(u'core_document', 'processing_end_ts',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Document.processing_begin_ts'
        db.delete_column(u'core_document', 'processing_begin_ts')

        # Deleting field 'Document.processing_end_ts'
        db.delete_column(u'core_document', 'processing_end_ts')
