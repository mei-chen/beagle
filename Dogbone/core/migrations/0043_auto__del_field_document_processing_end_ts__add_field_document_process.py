...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Document.processing_end_timestamp'
        db.add_column(u'core_document', 'processing_end_timestamp',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Document.processing_end_timestamp'
        db.delete_column(u'core_document', 'processing_end_timestamp')
