...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Sentence.prev_revision'
        db.alter_column(u'core_sentence', 'prev_revision_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['core.Sentence']))
        # Adding unique constraint on 'Sentence', fields ['prev_revision']
        db.create_unique(u'core_sentence', ['prev_revision_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Sentence', fields ['prev_revision']
        db.delete_unique(u'core_sentence', ['prev_revision_id'])


        # Changing field 'Sentence.prev_revision'
        db.alter_column(u'core_sentence', 'prev_revision_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.Sentence']))
