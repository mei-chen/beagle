...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExternalInvite'
        db.create_table(u'core_externalinvite', (
            ...
            ('email_sent_date', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'core', ['ExternalInvite'])


    def backwards(self, orm):
        # Deleting model 'ExternalInvite'
        db.delete_table(u'core_externalinvite')
    ...
    models = {
        ...
        u'core.externalinvite': {
            'Meta': {'object_name': 'ExternalInvite'},
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'document': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Document']"}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75'}),
            'email_sent_date': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
