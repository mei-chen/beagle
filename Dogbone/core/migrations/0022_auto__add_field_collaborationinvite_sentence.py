...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CollaborationInvite.sentence'
        db.add_column(u'core_collaborationinvite', 'sentence',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Sentence'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CollaborationInvite.sentence'
        db.delete_column(u'core_collaborationinvite', 'sentence_id')
