...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'core_queuetoupload', (
            ...
            ('error_message', self.gf('django.db.models.fields.CharField')(default=None, max_length=400, null=True, blank=True)),
            ...
            ('upload', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Batch'])),
