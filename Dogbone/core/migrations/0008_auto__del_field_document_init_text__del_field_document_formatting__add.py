...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Document.init_text'
        db.delete_column(u'core_document', 'init_text')

        # Deleting field 'Document.formatting'
        db.delete_column(u'core_document', 'formatting')

        # Adding field 'Sentence.formatting'
        db.add_column(u'core_sentence', 'formatting',
                      self.gf('jsonfield.fields.JSONField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Document.init_text'
        db.add_column(u'core_document', 'init_text',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'Document.formatting'
        db.add_column(u'core_document', 'formatting',
                      self.gf('jsonfield.fields.JSONField')(null=True),
                      keep_default=False)

        # Deleting field 'Sentence.formatting'
        db.delete_column(u'core_sentence', 'formatting')
