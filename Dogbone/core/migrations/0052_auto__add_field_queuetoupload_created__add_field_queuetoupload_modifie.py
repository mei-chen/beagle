...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QueueToUpload.created'
        db.add_column(u'core_queuetoupload', 'created',
                      self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'QueueToUpload.modified'
        db.add_column(u'core_queuetoupload', 'modified',
                      self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'QueueToUpload.pending'
        db.add_column(u'core_queuetoupload', 'pending',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'QueueToUpload.failed'
        db.add_column(u'core_queuetoupload', 'failed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'QueueToUpload.error_message'
        db.add_column(u'core_queuetoupload', 'error_message',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=400, null=True, blank=True),
                      keep_default=False)

        # Adding field 'QueueToUpload.trash'
        db.add_column(u'core_queuetoupload', 'trash',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'UploadInfo.uploaded_date'
        db.delete_column(u'core_uploadinfo', 'uploaded_date')

        # Adding field 'UploadInfo.created'
        db.add_column(u'core_uploadinfo', 'created',
                      self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'UploadInfo.modified'
        db.add_column(u'core_uploadinfo', 'modified',
                      self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QueueToUpload.created'
        db.delete_column(u'core_queuetoupload', 'created')

        # Deleting field 'QueueToUpload.modified'
        db.delete_column(u'core_queuetoupload', 'modified')

        # Deleting field 'QueueToUpload.pending'
        db.delete_column(u'core_queuetoupload', 'pending')

        # Deleting field 'QueueToUpload.failed'
        db.delete_column(u'core_queuetoupload', 'failed')

        # Deleting field 'QueueToUpload.error_message'
        db.delete_column(u'core_queuetoupload', 'error_message')

        # Deleting field 'QueueToUpload.trash'
        db.delete_column(u'core_queuetoupload', 'trash')


        # User chose to not deal with backwards NULL issues for 'UploadInfo.uploaded_date'
        raise RuntimeError("Cannot reverse this migration. 'UploadInfo.uploaded_date' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'UploadInfo.uploaded_date'
        db.add_column(u'core_uploadinfo', 'uploaded_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True),
                      keep_default=False)

        # Deleting field 'UploadInfo.created'
        db.delete_column(u'core_uploadinfo', 'created')

        # Deleting field 'UploadInfo.modified'
        db.delete_column(u'core_uploadinfo', 'modified')
