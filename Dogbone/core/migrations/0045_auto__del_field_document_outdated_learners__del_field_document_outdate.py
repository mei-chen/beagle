...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Document.outdated_learners'
        db.delete_column(u'core_document', 'outdated_learners')

        # Deleting field 'Document.outdated_keywords'
        db.delete_column(u'core_document', 'outdated_keywords')

        # Adding field 'Document.keywords_state'
        db.add_column(u'core_document', 'keywords_state',
                      self.gf('jsonfield.fields.JSONField')(default=None, null=True),
                      keep_default=False)

        # Adding field 'Document.learners_state'
        db.add_column(u'core_document', 'learners_state',
                      self.gf('jsonfield.fields.JSONField')(default=None, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Document.outdated_learners'
        db.add_column(u'core_document', 'outdated_learners',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Document.outdated_keywords'
        db.add_column(u'core_document', 'outdated_keywords',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Document.keywords_state'
        db.delete_column(u'core_document', 'keywords_state')

        # Deleting field 'Document.learners_state'
        db.delete_column(u'core_document', 'learners_state')
