...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.agreement_type_confidence'
        db.add_column(u'core_document', 'agreement_type_confidence',
                      self.gf('django.db.models.fields.FloatField')(default=0.0, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Document.agreement_type_confidence'
        db.delete_column(u'core_document', 'agreement_type_confidence')
