...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Document.prepared'
        db.alter_column(u'core_document', 'prepared', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'Document.prepared'
        db.alter_column(u'core_document', 'prepared', self.gf('django.db.models.fields.BooleanField')())
