...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Sentence.newline'
        db.delete_column(u'core_sentence', 'newline')

        # Adding field 'Sentence.newlines'
        db.add_column(u'core_sentence', 'newlines',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Sentence.newline'
        db.add_column(u'core_sentence', 'newline',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Sentence.newlines'
        db.delete_column(u'core_sentence', 'newlines')
