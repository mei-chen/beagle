...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UploadInfo.send_notifications'
        db.delete_column(u'core_uploadinfo', 'send_notifications')


    def backwards(self, orm):
        # Adding field 'UploadInfo.send_notifications'
        db.add_column(u'core_uploadinfo', 'send_notifications',
