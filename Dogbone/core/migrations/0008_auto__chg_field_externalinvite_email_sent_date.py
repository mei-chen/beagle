...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ExternalInvite.email_sent_date'
        db.alter_column(u'core_externalinvite', 'email_sent_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'ExternalInvite.email_sent_date'
        db.alter_column(u'core_externalinvite', 'email_sent_date', self.gf('django.db.models.fields.DateTimeField')(default=2))
