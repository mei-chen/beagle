...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'QueueToUpload'
        db.create_table(u'core_queuetoupload', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('upload', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.UploadInfo'])),
            ...
            ('is_archive', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ...
        db.send_create_signal(u'core', ['QueueToUpload'])

        # Adding model 'UploadInfo'
        db.create_table(u'core_uploadinfo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('documents_count', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('members_count', self.gf('django.db.models.fields.IntegerField')()),
        ...
        # Adding field 'Document.prepared'
        db.add_column(u'core_document', 'prepared',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'QueueToUpload'
        db.delete_table(u'core_queuetoupload')
        ...
        # Deleting field 'Document.prepared'
        db.delete_column(u'core_document', 'prepared')
