...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.upload_source'
        db.add_column(u'core_document', 'upload_source',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Document.upload_source'
        db.delete_column(u'core_document', 'upload_source')
