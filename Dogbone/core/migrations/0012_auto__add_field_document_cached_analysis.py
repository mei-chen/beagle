...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.cached_analysis'
        db.add_column(u'core_document', 'cached_analysis',
                      self.gf('jsonfield.fields.JSONField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Document.cached_analysis'
        db.delete_column(u'core_document', 'cached_analysis')
