...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ExternalInvite.error_message'
        db.alter_column(u'core_externalinvite', 'error_message', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Document.error_message'
        db.alter_column(u'core_document', 'error_message', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'ExternalInvite.error_message'
        db.alter_column(u'core_externalinvite', 'error_message', self.gf('django.db.models.fields.CharField')(max_length=400, null=True))

        # Changing field 'Document.error_message'
        db.alter_column(u'core_document', 'error_message', self.gf('django.db.models.fields.CharField')(max_length=400, null=True))
