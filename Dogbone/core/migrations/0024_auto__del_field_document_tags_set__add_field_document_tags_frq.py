...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Document.tags_set'
        db.delete_column(u'core_document', 'tags_set')

        # Adding field 'Document.tags_frq'
        db.add_column(u'core_document', 'tags_frq',
                      self.gf('jsonfield.fields.JSONField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Document.tags_set'
        db.add_column(u'core_document', 'tags_set',
                      self.gf('jsonfield.fields.JSONField')(null=True),
                      keep_default=False)

        # Deleting field 'Document.tags_frq'
        db.delete_column(u'core_document', 'tags_frq')
