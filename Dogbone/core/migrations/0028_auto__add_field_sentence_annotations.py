...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sentence.annotations'
        db.add_column(u'core_sentence', 'annotations',
                      self.gf('jsonfield.fields.JSONField')(default=None, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sentence.annotations'
        db.delete_column(u'core_sentence', 'annotations')
