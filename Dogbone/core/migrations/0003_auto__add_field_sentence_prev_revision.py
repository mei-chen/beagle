...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sentence.prev_revision'
        db.add_column(u'core_sentence', 'prev_revision',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='next_revision', null=True, to=orm['core.Sentence']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sentence.prev_revision'
        db.delete_column(u'core_sentence', 'prev_revision_id')
    ...
    models = {
        ...
        u'core.sentence': {
            ...
            'prev_revision': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'next_revision'", 'null': 'True', 'to': u"orm['core.Sentence']"}),
