...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExternalInvite.failed'
        db.add_column(u'core_externalinvite', 'failed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ExternalInvite.error_message'
        db.add_column(u'core_externalinvite', 'error_message',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=400, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Document.failed'
        db.add_column(u'core_document', 'failed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Document.error_message'
        db.add_column(u'core_document', 'error_message',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=400, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExternalInvite.failed'
        db.delete_column(u'core_externalinvite', 'failed')

        # Deleting field 'ExternalInvite.error_message'
        db.delete_column(u'core_externalinvite', 'error_message')

        # Deleting field 'Document.failed'
        db.delete_column(u'core_document', 'failed')

        # Deleting field 'Document.error_message'
        db.delete_column(u'core_document', 'error_message')
    ...
    models = {
        ...
        u'core.document': {
            ...
            'processing_begin_ts': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True'}),
            'processing_end_ts': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True'}),
        ...
        u'core.sentence': {
            ...
            'annotations': ('jsonfield.fields.JSONField', [], {'default': 'None', 'null': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'likes': ('jsonfield.fields.JSONField', [], {'null': 'True'}),
            ...
            'style': ('jsonfield.fields.JSONField', [], {'null': 'True'}),
