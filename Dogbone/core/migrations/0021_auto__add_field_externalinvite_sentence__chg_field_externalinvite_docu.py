...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExternalInvite.sentence'
        db.add_column(u'core_externalinvite', 'sentence',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['core.Sentence'], null=True),
                      keep_default=False)


        # Changing field 'ExternalInvite.document'
        db.alter_column(u'core_externalinvite', 'document_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Document'], null=True))

    def backwards(self, orm):
        # Deleting field 'ExternalInvite.sentence'
        db.delete_column(u'core_externalinvite', 'sentence_id')


        # Changing field 'ExternalInvite.document'
        db.alter_column(u'core_externalinvite', 'document_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['core.Document']))
    ...
    models = {
        ...
        u'core.sentence': {
            ...
            'suggested_tags': ('jsonfield.fields.JSONField', [], {'default': 'None', 'null': 'True'}),
            'tags': ('jsonfield.fields.JSONField', [], {'default': 'None', 'null': 'True'}),
