...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'core_uploadinfo')
        ...
        db.create_table(u'core_batch', (
            ...
            ('docs', self.gf('jsonfield.fields.JSONField')(null=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'core', ['Batch'])


        # Changing field 'QueueToUpload.upload'
        db.alter_column(u'core_queuetoupload', 'upload_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Batch']))
        # Deleting field 'Document.upload_info'
        db.delete_column(u'core_document', 'upload_info_id')

        # Adding field 'Document.batch'
        db.add_column(u'core_document', 'batch',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['core.Batch'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding model 'UploadInfo'
        db.create_table(u'core_uploadinfo', (
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('docs', self.gf('jsonfield.fields.JSONField')(null=True)),
        ...
        db.send_create_signal(u'core', ['UploadInfo'])
        ...
        # Changing field 'QueueToUpload.upload'
        db.alter_column(u'core_queuetoupload', 'upload_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.UploadInfo']))
        # Adding field 'Document.upload_info'
        db.add_column(u'core_document', 'upload_info',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['core.UploadInfo'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Document.batch'
        db.delete_column(u'core_document', 'batch_id')
    ...
    models = {
        ...
        u'core.queuetoupload': {
            ...
            'trash': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'upload': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Batch']"})
        },
        u'core.sentence': {
