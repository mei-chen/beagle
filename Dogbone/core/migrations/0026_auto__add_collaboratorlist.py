...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CollaboratorList'
        db.create_table(u'core_collaboratorlist', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='collaborator_aggregate', unique=True, to=orm['auth.User'])),
            ('collaborator_suggestions', self.gf('jsonfield.fields.JSONField')(null=True)),
        ))
        db.send_create_signal(u'core', ['CollaboratorList'])


    def backwards(self, orm):
        # Deleting model 'CollaboratorList'
        db.delete_table(u'core_collaboratorlist')
