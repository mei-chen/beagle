...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Document.agreement_type' to match new field type.
        db.rename_column(u'core_document', 'agreement_type_id', 'agreement_type')
        # Changing field 'Document.agreement_type'
        db.alter_column(u'core_document', 'agreement_type', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))
        # Removing index on 'Document', fields ['agreement_type']
        db.delete_index(u'core_document', ['agreement_type_id'])


    def backwards(self, orm):
        # Adding index on 'Document', fields ['agreement_type']
        db.create_index(u'core_document', ['agreement_type_id'])


        # Renaming column for 'Document.agreement_type' to match new field type.
        db.rename_column(u'core_document', 'agreement_type', 'agreement_type_id')
        # Changing field 'Document.agreement_type'
        db.alter_column(u'core_document', 'agreement_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.DocumentType'], null=True))
