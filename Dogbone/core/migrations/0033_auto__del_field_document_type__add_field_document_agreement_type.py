...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'core_document', 'type_id')

        # Adding field 'Document.agreement_type'
        db.add_column(u'core_document', 'agreement_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.DocumentType'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Document.type'
        db.add_column(u'core_document', 'type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.DocumentType'], null=True),
                      keep_default=False)

        # Deleting field 'Document.agreement_type'
        db.delete_column(u'core_document', 'agreement_type_id')
    ...
    models = {
        ...
        u'core.document': {
            ...
            'agreement_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.DocumentType']", 'null': 'True'}),
