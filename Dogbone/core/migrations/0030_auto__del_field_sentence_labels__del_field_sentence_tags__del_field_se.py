...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Sentence.labels'
        db.delete_column(u'core_sentence', 'labels')

        # Deleting field 'Sentence.tags'
        db.delete_column(u'core_sentence', 'tags')

        # Deleting field 'Sentence.suggested_tags'
        db.delete_column(u'core_sentence', 'suggested_tags')

    def backwards(self, orm):
        # Adding field 'Sentence.labels'
        db.add_column(u'core_sentence', 'labels',
                      self.gf('jsonfield.fields.JSONField')(null=True),
                      keep_default=False)

        # Adding field 'Sentence.tags'
        db.add_column(u'core_sentence', 'tags',
                      self.gf('jsonfield.fields.JSONField')(default=None, null=True),
                      keep_default=False)

        # Adding field 'Sentence.suggested_tags'
        db.add_column(u'core_sentence', 'suggested_tags',
                      self.gf('jsonfield.fields.JSONField')(default=None, null=True),
                      keep_default=False)
