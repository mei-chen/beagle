...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Batch.pending'
        db.add_column(u'core_batch', 'pending',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Batch.failed'
        db.add_column(u'core_batch', 'failed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Batch.error_message'
        db.add_column(u'core_batch', 'error_message',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Batch.pending'
        db.delete_column(u'core_batch', 'pending')

        # Deleting field 'Batch.failed'
        db.delete_column(u'core_batch', 'failed')

        # Deleting field 'Batch.error_message'
        db.delete_column(u'core_batch', 'error_message')
