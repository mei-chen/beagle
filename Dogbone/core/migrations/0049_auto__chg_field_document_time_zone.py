...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Document.time_zone'
        db.alter_column(u'core_document', 'time_zone', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'Document.time_zone'
        db.alter_column(u'core_document', 'time_zone', self.gf('django.db.models.fields.CharField')(max_length=50))
