...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.time_zone'
        db.add_column(u'core_document', 'time_zone',
                      self.gf('django.db.models.fields.CharField')(default='UTC', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Document.time_zone'
        db.delete_column(u'core_document', 'time_zone')
    ...
    models = {
        ...
        u'core.document': {
            ...
            'time_zone': ('django.db.models.fields.CharField', [], {'default': "'UTC'", 'max_length': '50'}),
