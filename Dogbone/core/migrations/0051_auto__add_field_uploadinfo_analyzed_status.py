...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UploadInfo.analyzed_status'
        db.add_column(u'core_uploadinfo', 'analyzed_status',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UploadInfo.analyzed_status'
        db.delete_column(u'core_uploadinfo', 'analyzed_status')
