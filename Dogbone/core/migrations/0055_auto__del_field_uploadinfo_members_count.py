...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UploadInfo.members_count'
        db.delete_column(u'core_uploadinfo', 'members_count')


    def backwards(self, orm):
        # Adding field 'UploadInfo.members_count'
        db.add_column(u'core_uploadinfo', 'members_count',
