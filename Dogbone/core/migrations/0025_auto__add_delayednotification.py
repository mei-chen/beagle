...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DelayedNotification'
        db.create_table(u'core_delayednotification', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('notification', self.gf('picklefield.fields.PickledObjectField')()),
            ('user_fields', self.gf('jsonfield.fields.JSONField')(default={'fields': []})),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('transient', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'core', ['DelayedNotification'])


    def backwards(self, orm):
        # Deleting model 'DelayedNotification'
        db.delete_table(u'core_delayednotification')
