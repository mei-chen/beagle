...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'core_documenttype', (
            ('samples_folder', self.gf('django.db.models.fields.CharField')(max_length=500, unique=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200, unique=True)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=200, unique=True)),
        ))
