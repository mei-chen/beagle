...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UploadInfo.documents_count'
        db.delete_column(u'core_uploadinfo', 'documents_count')


    def backwards(self, orm):
        # Adding field 'UploadInfo.documents_count'
        db.add_column(u'core_uploadinfo', 'documents_count',
