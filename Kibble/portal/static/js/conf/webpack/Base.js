...
class WebpackBaseConfig {
  ...
  get defaultSettings() {
    ...
    return {
      ...
      resolve: {
        alias: {
          LocalFolder: `${this.srcPathAbsolute}/LocalFolder/`,
          OnlineFolder: `${this.srcPathAbsolute}/OnlineFolder/`,
          ProjectManagement: `${this.srcPathAbsolute}/ProjectManagement/`,
          BatchManagement: `${this.srcPathAbsolute}/BatchManagement/`,
          OCR: `${this.srcPathAbsolute}/OCR/`,
