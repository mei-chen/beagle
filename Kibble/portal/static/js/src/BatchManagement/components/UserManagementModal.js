...
class UserManagementModal extends React.Component {
  ...
  componentDidMount() {
    const { getCollaboratorsForBatch, requestCollaborators, id } = this.props;
    requestCollaborators();
    getCollaboratorsForBatch(id);
  }
          ...
          (
            collaborators_error ?
              ...
              <Collaborators
                ...
                getCollaborators={getCollaboratorsForBatch}
                id={id}
              />
          ) :
          <Spinner/>
