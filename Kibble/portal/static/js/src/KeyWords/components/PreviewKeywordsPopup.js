...
import { MODULE_NAME as KEY_WORDS_MODULE_NAME } from 'KeyWords/constants';
  ...
  render() {
    return (
      <tr key={this.props.reportKey}>
        ...
        <td>{this.props.report.keywordlist}</td>
        <td>{this.props.report.keyword}</td>
...
const ReportRow = connect(
  (state) => ({
    selectedBatchId: state[ KEY_WORDS_MODULE_NAME ].get('selectedBatchId'),
    selectedProjectId: state[ KEY_WORDS_MODULE_NAME ].get('selectedProjectId'),
  }),
...
const PreviewKeywordsPopup = ({ isOpen, title, report, onClose }) => (
...
PreviewKeywordsPopup.propTypes = {
  isOpen: PropTypes.bool.isRequired,
  title: PropTypes.string.isRequired,
  onClose: PropTypes.func.isRequired,
};

export default PreviewKeywordsPopup;
