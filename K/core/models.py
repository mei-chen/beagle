...
class ProjectCollaborationInvite(CollaborationInvite):
    ...
    invitee = models.ForeignKey(User, related_name='project_collaboration_invites_received')
    inviter = models.ForeignKey(User, related_name='project_collaboration_invites_sent')

    project = models.ForeignKey(Project, related_name='collaboration_invites')
...
class BatchCollaborationInvite(CollaborationInvite):
    ...
    invitee = models.ForeignKey(User, related_name='batch_collaboration_invites_received')
    inviter = models.ForeignKey(User, related_name='batch_collaboration_invites_sent')

    batch = models.ForeignKey(Batch, related_name='collaboration_invites')
