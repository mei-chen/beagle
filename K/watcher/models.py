...
class CloudFolder(TimeStampedModel):
    ...
    batch = models.OneToOneField(Batch, null=True, blank=True)
...
class CloudFile(TimeStampedModel):
    folder = models.ForeignKey(CloudFolder, related_name='files')
    file_object = models.OneToOneField(File, null=True, blank=True)
